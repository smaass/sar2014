...
// Used in day.php
$vocab["bookingsfor"]        = "Reservas para él/ella";
$vocab["bookingsforpost"]    = "";
$vocab["areas"]              = "Grupos";
$vocab["daybefore"]          = "Día Anterior";
$vocab["dayafter"]           = "Dí­a Siguiente";
...
$vocab["rep_rep_day"]        = "Dí­a Repetición";
...
$vocab["missing_mandatory_field"] = "No se ha incluÃ­do un valor para un campo obligatorio";
...
$vocab["no_request_yet"]      = "Todaví­a no se ha enviado ninguna solicitud"; // Used for the title tooltip on More Info button
...
$vocab["too_may_entrys"]     = "Las opciones seleccionadas crearÃ¡n demasiadas entradas.<br>Por favor, revise las opciones";
...
$vocab["passwords_not_eq"]   = "Error: Las contraseñs no son iguales.";
...
$vocab["no_users_initial"]   = "No hay usuarios en la Base de Datos, permitiendo la creación del usuario inicial";
...
$vocab["warning_last_admin"] = "¡Atención! Este es el último administrador y por eso no puede ser borrado o quitarle los derechos de administración; si se hiciera, el sistema quedarí­a bloqueado.";
...
// Used in week.php
$vocab["weekbefore"]         = "Semana Anterior";
$vocab["weekafter"]          = "Semana Posterior";
$vocab["gotothisweek"]       = "Semana Actual";

// Used in month.php
$vocab["monthbefore"]        = "Mes Anterior";
$vocab["monthafter"]         = "Mes Posterior";
$vocab["gotothismonth"]      = "Mes Actual";

// Used in {day week month}.php
$vocab["no_rooms_for_area"]  = "No hay Salas definidas para este conjunto";
...
$vocab["in"]                 = "en";
$vocab["noareas"]            = "No hay conjuntos";
$vocab["noareas_enabled"]    = "No hay conjuntos habilitados.";
$vocab["addarea"]            = "Agregar conjunto";
$vocab["name"]               = "Nombre";
$vocab["noarea"]             = "No se seleccionó conjunto";
$vocab["browserlang"]        = "Su navegador está configurado para usar los siguientes juegos de caracteres";
$vocab["addroom"]            = "Agregar Recurso";
...
$vocab["invalid_area_name"]  = "Este nombre de conjunto ya está siendo utilizado";
$vocab["empty_name"]         = "¡No se ha escrito un nombre!";

// Used in edit_area_room.php
$vocab["editarea"]           = "Editar conjunto";
$vocab["change"]             = "Cambiar";
$vocab["backadmin"]          = "Volver a Admin";
$vocab["editroomarea"]       = "Editar descripción de conjunto";
$vocab["editroom"]           = "Editar Sala";
$vocab["viewroom"]                = "Ver Sala";
$vocab["update_room_failed"] = "ActualizaciÃ³n de Sala fallida: ";
...
$vocab["room_admin_email"]   = "Correo Electrónico del Administrador de Recurso";
...
$vocab["invalid_area"]            = "¡Conjunto no válido!";
$vocab["invalid_room_name"]       = "¡Este nombre de recurso ya se ha usado en este conjunto!";
...
$vocab["private_display_caution"] = "¡CUIDADO: piense en las implicancias sobre la privacidad, antes de cambiar estos ajustes!";
...
$vocab["max_book_ahead"]          = "Reservas futuras - má¡ximo";
...
$vocab["email_list_note"]         = "Incluir una lista de direcciones email separadas por comas o saltos de lí­nea";
$vocab["mode"]                    = "Modo";
...
$vocab["disabled_area_note"]      = "Si esta Conjunto está deshabilitada, no aparecerá en las vistas de calendario " .
...
$vocab["disabled_room_note"]      = "Si esta Sala está deshabilitada, no aparecerá en las vistas de calendario " .
                                    "y no será posible hacer nuevas reservas en ella. Sin embargo, las reservas existentes " .
                                    "serán respetadas y por ello serán visibles en los resultados de Búsqueda e Informes.";
$vocab["book_ahead_note_periods"] = "Cuando se usan periodos, las horas de reservas futuras se redondearán al dí­a completo más cercano  .";
...
$vocab["YES"]                = "SÍ";
$vocab["NO"]                 = "NO";
$vocab["delarea"]            = "Debe borrar todos los Recursos antes de borrar este Conjunto<p>";
