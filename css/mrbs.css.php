...
.form_admin label {
    ...
    width: <?php echo $admin_form_label_width ?>em; min-height: 2.0em; text-align: left;
}
.form_admin input {
...
$edit_entry_left_col_max_width = '10.5';      // em
...
.required_complete{
  background-color: rgba(70,200,70,0.1);
